...
public class BusinessCategoryController {
	...
	private List<ErrorResponse> validateBusinessCategoryRequest(final BusinessCategoryRequest businessCategoryRequest,
			Boolean isUpdate) {
		final ResponseInfo responseInfo = responseInfoFact
				.createResponseInfoFromRequestInfo(businessCategoryRequest.getRequestInfo(), false);
	...
	private org.egov.common.contract.response.Error getError(final BusinessCategoryRequest businessCategoryRequest,
			Boolean isUpdate) {
	...
	private void addCodeValidationErrors(BusinessCategoryRequest businessCategoryRequest, List<ErrorField> errorFields,
			Boolean isUpdate) {
